...
const translations: Record<Language, Translations> = {
  en: {
    ...
    manualTokenIssue: "Manual Registration",
    issueManualToken: "Issue Manual Registration",
  ...
  hi: {
    ...
    manualTokenIssue: "मैनुअल पंजीकरण",
    issueManualToken: "मैनुअल पंजीकरण जारी करें",
  ...
  mr: {
    ...
    manualTokenIssue: "मॅन्युअल नोंदणी",
    issueManualToken: "मॅन्युअल नोंदणी जारी करा",
